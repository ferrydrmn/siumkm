...
class User(db.Model, UserMixin): 
    ...
    excel = db.relationship('Excel', backref=db.backref('user', cascade='all, delete'), lazy=True)
...
class Province(db.Model):
    ...
    district = db.relationship('District', backref=db.backref('province', cascade='all, delete'), lazy=True)
...
class District(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_province = db.Column(db.Integer, db.ForeignKey('province.id', ondelete='CASCADE'), nullable=False)
    name = db.Column(db.String(255), nullable=False)
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)
    sub_district = db.relationship('Sub_District', backref=db.backref('district', cascade='all, delete'), lazy=True)
...
class Sub_District(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    id_district = db.Column(db.Integer, db.ForeignKey('district.id', ondelete='CASCADE'), nullable=False)
    name = db.Column(db.String(255), nullable=False)
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)
    ward = db.relationship('Ward', backref=db.backref('sub_district', cascade='all, delete'), lazy=True)
...
class Ward(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    id_sub_district = db.Column(db.Integer, db.ForeignKey('sub_district.id', ondelete='CASCADE'), nullable=False)
    name = db.Column(db.String(255), nullable=False)
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)
    owner = db.relationship('Owner', backref='ward', lazy=True)
    umkm = db.relationship('Umkm', backref=db.backref('ward', cascade='all, delete'), lazy=True)
...
class Owner(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_ward = db.Column(db.Integer, db.ForeignKey('ward.id', ondelete='CASCADE'), nullable=False)
    ...
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)
    umkm = db.relationship('Umkm', backref=db.backref('owner', cascade='all, delete'), lazy=True)
...
class Umkm(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_owner = db.Column(db.Integer, db.ForeignKey('owner.id', ondelete='CASCADE'), nullable=False)
    id_ward = db.Column(db.Integer, db.ForeignKey('ward.id', ondelete='CASCADE'), nullable=False)
    id_business_category = db.Column(db.Integer,db.ForeignKey('business_category.id', ondelete='CASCADE'), nullable=False)
    name = db.Column(db.String(255), nullable=False, unique=True)
    ...
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)
    brand = db.relationship('Brand', backref=db.backref('umkm', cascade='all, delete'), lazy=True)
...
class Business_Category(db.Model):
    ...
    umkm = db.relationship('Umkm', backref=db.backref('business_category', cascade='all, delete'), lazy=True)
...
class Brand(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_umkm = db.Column(db.Integer, db.ForeignKey('umkm.id', ondelete='CASCADE'), nullable=False)
    brand = db.Column(db.String(255), nullable=False, unique=True)
    created_at = db.Column(db.Date)
    updated_at = db.Column(db.Date)

    product = db.relationship('Product', backref=db.backref('brand', cascade='all, delete'), lazy=True)
...
class Product(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_brand = db.Column(db.Integer, db.ForeignKey('brand.id', ondelete='CASCADE'), nullable=False)
    id_type = db.Column(db.Integer, db.ForeignKey('product_type.id', ondelete='CASCADE'), nullable=False)
    id_category = db.Column(db.Integer, db.ForeignKey('product_category.id', ondelete='CASCADE'), nullable=False)
    name = db.Column(db.String(255), nullable=False)
...
class Product_Type(db.Model):
    ...
    product = db.relationship('Product', backref=db.backref('product_type', cascade='all, delete'), lazy=True)
...
class Product_Category(db.Model):
    ...
    product = db.relationship('Product', backref=db.backref('product_category', cascade='all, delete'), lazy=True)
...
class Excel(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    id_type = db.Column(db.Integer, db.ForeignKey('excel_type.id', ondelete='CASCADE'), nullable=False)
    id_user = db.Column(db.String(22), db.ForeignKey('user.id', ondelete='CASCADE'), nullable=False)
...
class Excel_Type(db.Model):
    ...
    excel = db.relationship('Excel', backref=db.backref("excel_type", cascade="all,delete"), lazy=True)
